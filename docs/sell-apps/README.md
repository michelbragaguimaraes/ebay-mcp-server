...
This document provides a structured overview and direct links to the official eBay API documentation, categorized by their primary function and whether they are part of the "Selling Apps" or "Buying Apps" suite.
...
- **Inventory Mapping**: [Overview](https://developer.ebay.com/develop/api/sell/inventory_mapping)
...
- **Taxonomy API**: [Overview](https://developer.ebay.com/api-docs/sell/taxonomy/overview.html)
- **Catalog API**: [Overview](https://developer.ebay.com/api-docs/master/commerce/taxonomy/openapi/3/commerce_taxonomy_v1_oas3.json)
...
- **Feedback API**: [Resources/Methods](https://developer.ebay.com/api-docs/master/commerce/feedback/openapi/3/commerce_feedback_v1_beta_oas3.json)
...
- **Logistics API**: [Resources/Methods](https://developer.ebay.com/api-docs/master/sell/logistics/openapi/3/sell_logistics_v1_oas3.json)
- **Post-Order API**: [Index](https://developer.ebay.com/devzone/post-order/index.html)
- **Order Management (XML)**: [Reference](https://developer.ebay.com/devzone/xml/docs/Reference/eBay/OrderManagementIndex.html)
...
These APIs are designed for buyers and third-party applications to discover inventory, manage purchases, and interact with eBay's marketplace.

### Inventory Discovery & Refresh

- **Browse API**: [Overview](https://developer.ebay.com/api-docs/master/buy/browse/openapi/3/buy_browse_v1_oas3.json)
- **Feed API (v1)**: [Overview](https://developer.ebay.com/api-docs/master/buy/feed/openapi/3/buy_feed_v1_beta_oas3.json)
- **Feed API (v2)**: [Overview](https://developer.ebay.com/api-docs/master/buy/feed/v1/openapi/3/buy_feed_v1_oas3.json)
- **Notification API**: [Overview](https://developer.ebay.com/api-docs/master/commerce/notification/openapi/3/commerce_notification_v1_oas3.json)

### Marketing & Discounts

- **Deal API**: [Overview](https://developer.ebay.com/api-docs/master/buy/deal/openapi/3/buy_deal_v1_oas3.json)
- **Marketing API**: [Overview](https://developer.ebay.com/api-docs/master/buy/marketing/openapi/3/buy_marketing_v1_beta_oas3.json)
...
- **Catalog API**: [Overview](https://developer.ebay.com/api-docs/master/commerce/catalog/openapi/3/commerce_catalog_v1_beta_oas3.json)
- **Charity API**: [Overview](https://developer.ebay.com/api-docs/master/commerce/charity/openapi/3/commerce_charity_v1_oas3.json)

### Checkout & Bidding

- **Order API**: [Overview](https://developer.ebay.com/api-docs/master/buy/order/openapi/3/buy_order_v2_oas3.json)
- **Offer API**: [Overview](https://developer.ebay.com/api-docs/master/buy/offer/openapi/3/buy_offer_v1_beta_oas3.json)
