...
describe("AccountApi", () => {
  ...
  describe("Fulfillment Policies", () => {
    ...
    it("should get fulfillment policy by name", async () => {
      ...
      const result = await accountApi.getFulfillmentPolicyByName(
        "EBAY_US",
        "Standard Shipping"
      );

      expect(mockClient.get).toHaveBeenCalledWith(
        "/sell/account/v1/fulfillment_policy_by_name",
        { marketplace_id: "EBAY_US", name: "Standard Shipping" }
      );
      expect(result).toEqual(mockPolicy);
    });
    ...
    it("should update a fulfillment policy", async () => {
      ...
      const result = await accountApi.updateFulfillmentPolicy(
        "1234567890",
        policyRequest
      );
  ...
  describe("Payment Policies", () => {
    ...
    it("should get payment policy by name", async () => {
      ...
      const result = await accountApi.getPaymentPolicyByName(
        "EBAY_US",
        "Immediate Payment"
      );

      expect(mockClient.get).toHaveBeenCalledWith(
        "/sell/account/v1/payment_policy_by_name",
        { marketplace_id: "EBAY_US", name: "Immediate Payment" }
      );
      expect(result).toEqual(mockPolicy);
    });
    ...
    it("should update a payment policy", async () => {
      ...
      const result = await accountApi.updatePaymentPolicy(
        "1234567890",
        policyRequest
      );
  ...
  describe("Return Policies", () => {
    ...
    it("should get return policy by name", async () => {
      ...
      const result = await accountApi.getReturnPolicyByName(
        "EBAY_US",
        "30 Day Returns"
      );

      expect(mockClient.get).toHaveBeenCalledWith(
        "/sell/account/v1/return_policy_by_name",
        { marketplace_id: "EBAY_US", name: "30 Day Returns" }
      );
      expect(result).toEqual(mockPolicy);
    });
    ...
    it("should update a return policy", async () => {
      ...
      const result = await accountApi.updateReturnPolicy(
        "1234567890",
        policyRequest
      );
  ...
  describe("Payments Program", () => {
    it("should opt-in to payments program", async () => {
      ...
      const result = await accountApi.optInToPaymentsProgram(
        "EBAY_US",
        "EBAY_PAYMENTS"
      );
    ...
    it("should get payments program status", async () => {
      ...
      const result = await accountApi.getPaymentsProgramStatus(
        "EBAY_US",
        "EBAY_PAYMENTS"
      );
  ...
  describe("Sales Tax", () => {
    ...
    it("should get specific sales tax", async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith(
        "/sell/account/v1/sales_tax/US/CA"
      );
